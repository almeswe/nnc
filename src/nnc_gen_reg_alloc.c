...
//};
//
//typedef struct _nnc_reg_state {
//    vector(nnc_3a_lr*) lr;
//} nnc_reg_state;
//
//nnc_static nnc_bool nnc_lr_is_empty(nnc_asm_reg reg) {
//    vector(nnc_3a_lr*) lr = nnc_reg_lr[reg].lr;
//    return lr == NULL || buf_len(lr) == 0;
//}
//
//nnc_static nnc_3a_lr* nnc_peek_reg(nnc_asm_reg reg) {
//    vector(nnc_3a_lr*) lr = nnc_reg_lr[reg].lr;
//    assert(lr != NULL);
//    return buf_last(lr);
//}
//
//nnc_static void nnc_push_reg(nnc_asm_reg reg) {
//    vector(nnc_3a_lr*) lr = nnc_reg_lr[reg].lr;
//    buf_add(lr, NULL);
//}
//
//nnc_static void nnc_pop_reg(nnc_asm_reg reg) {
//    vector(nnc_3a_lr*) lr = nnc_reg_lr[reg].lr;
//    assert(lr != NULL);
//    buf_pop(lr);
//}
//
//nnc_static nnc_bool nnc_reserve_reg(nnc_asm_reg reg) {
//    assert(nnc_glob_unit != NULL);
//    nnc_bool pushed = false;
//    if (nnc_reg_in_use(nnc_glob_unit, reg)) {
//        nnc_push_reg(reg), pushed = true;
//    }
//    return pushed;
//}
//
//nnc_static nnc_bool nnc_unreserve_reg(nnc_asm_reg reg) {
//    assert(nnc_glob_unit != NULL);
//    nnc_peek_reg(reg);
//}
//
//nnc_static nnc_reg_state nnc_reg_lr[] = {
//    [R_RAX]  = { NULL },
//    [R_RBX]  = { NULL },
//    [R_R10]  = { NULL },
//    [R_R11]  = { NULL },
...
//    //todo: alignment?
//    if (nnc_glob_unit->stack_offset == 0) {
//        nnc_glob_unit->stack_offset = 8;
//    }
//    lr->storage.mem_offset = nnc_glob_unit->stack_offset;
//    lr->storage.where = STORAGE_STACK_SEG;
//    nnc_glob_unit->stack_offset += local->type->size;
//    return &lr->storage;
//}
//
...
//        nnc_asm_reg_lr_rec* rec = &nnc_reg_lr[params->priority[i]];
...
//}
//
//nnc_static nnc_reg_alloc_state state = { 0 };
//
//const nnc_3a_storage* nnc_reg_alloc_state_next(const nnc_3a_addr* addr) {
//
//}
//
//void nnc_reg_alloc_state_fini() {
//    state.alloc_simd_idx = 0;
...
//    if (lr->storage.where != STORAGE_NONE && mode != STORE_PARAM) {
//        return &lr->storage;
//    }
//    switch (mode) {
...
//        .ends   = UINT32_MAX
//    };
//    return nnc_3a_lr_intersects(&lr, nnc_reg_lr[reg].lr);
//}
//
//typedef struct _nnc_bin {
//    nnc_3a_storage at;
//    const nnc_3a_lr* lr;
//} nnc_bin;
//
//nnc_static nnc_bin nnc_bin_for_argument(const nnc_3a_unit* unit, const nnc_3a_addr* arg) {
//    // initialize priority lists
//    const nnc_asm_reg gen_p[] = {
//        R_RDI, R_RSI, R_RDX, R_RCX, R_R8, R_R9
//    };
...
//        R_XMM4, R_XMM5, R_XMM6, R_XMM7
//    };
//    nnc_3a_lr* lr = nnc_get_lr(unit, arg);
//    // initialize params
//    nnc_store_params params = {
//        .lr            = lr,
//        .generic       = arg,
//        .priority      = nnc_real_type(arg->type) ? flt_p : gen_p,
//        .priority_size = nnc_real_type(arg->type) ?
//            nnc_arr_size(flt_p) : nnc_arr_size(gen_p)
//    };
//    for (nnc_u64 i = 0; i < params.priority_size; i++) {
//        // get mapping record (register => live range associated with it)
...
//        .lr = lr,
//        .at = {
//            .mem_offset = unit->stack_offset,
//            .where = STORAGE_STACK_SEG
//        }
//    };  
//}
//
////nnc_static const nnc_3a_storage* nnc_store_argument(const nnc_3a_unit* unit, const nnc_3a_addr* arg) {
////
////    // call genetic function for storing
////    return nnc_perform_store(&params, nnc_store_param_in_mem);
////}